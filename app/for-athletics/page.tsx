  ...
  return (
    <>
      ...
      <main style={{ paddingTop: 72, minHeight: "100vh" }}>
        ...
        {/* HERO */}
        <PageHero
          label="For Administration & Athletics"
        ...
        <section style={{ background: "var(--cream2)", padding: "72px 0" }}>
          <div style={{ maxWidth: 640, margin: "0 auto", padding: "0 24px", textAlign: "center" }}>
            <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: ".1em", color: "var(--green)", marginBottom: 14, display: "block" }}>Pricing</span>
            <h2 style={{ fontSize: "clamp(24px, 3vw, 36px)", fontWeight: 800, color: "var(--navy)", marginBottom: 12, letterSpacing: "-.025em" }}>
              One professional build. Everything included.
            </h2>
            <div style={{ background: "#fff", border: "2px solid var(--green)", borderRadius: 18, padding: "36px 32px", marginTop: 28, boxShadow: "0 16px 48px rgba(11,23,41,.07)" }}>
              ...
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center" }}>
                ...
                <a href="/consultation" className="btn-outline-dark">Talk It Through First</a>
              </div>
            </div>
            <p style={{ fontSize: 13.5, lineHeight: 1.7, color: "rgba(11,23,41,.55)", marginTop: 18 }}>
