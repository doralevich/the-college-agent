...
// 12 voice/personality options modelled on real, widely-admired public figures
// (6 men, 6 women). Radio = single pick. The label drives SOUL.md tone — the agent
// emulates the style, it isn't impersonating the person.
const VOICES = [
