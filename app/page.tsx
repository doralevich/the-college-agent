      ...
      <section id="how-it-works" className="dark-section" style={{ padding: "80px 0" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 700, margin: "0 auto" }}>
            {[
              { n: "1", phase: "Step 1", title: "Tell Us About You", desc: "Fill out a short profile — your school, year, AI comfort level, and the tools you already live in: Canvas, Notion, Gmail, Discord, LinkedIn, and 60+ more. Then choose your framework, hosting plan, and support level. Under five minutes.", last: false },
              { n: "2", phase: "Step 2", title: "We Build Your Agent", desc: "Our team names and configures your AI personal agent, connects it to your existing tools, and trains it on your communication style, your schedule, and your goals. No generic setup — everything is built around how you actually work. Live within 72 hours of your setup call.", last: false },
              { n: "3", phase: "Step 3", title: "30 Days Side by Side", desc: "Your setup fee includes a full 30-day co-training period. We work alongside you and your agent — refining how it responds, adjusting integrations as your semester shifts, and making sure it sounds like you, not like a chatbot. By day 30, it knows your rhythm.", last: false },
              { n: "4", phase: "Step 4", title: "You Own It", desc: "After co-training, the agent is yours. Go independent, or keep a semester or annual support plan for ongoing updates, new integrations, and priority access as we ship new capabilities. No lock-in. No mandatory fees. Just your agent, working for you.", last: true },
            ].map((step) => (
