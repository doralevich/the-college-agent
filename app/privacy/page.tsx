        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "48px 24px 100px" }}>
          ...
          <Section title="2. Information We Collect">
            ...
            <ul>
              ...
              <li><strong>Uploaded Files:</strong> Any documents (such as resumes) you submit through our forms.</li>
            </ul>
          </Section>
          ...
          <Section title="5. Data Sharing">
            ...
            <ul>
              ...
              <li><strong>Service Providers:</strong> Third-party vendors who assist in operating our platform (e.g., hosting, email delivery), bound by confidentiality agreements.</li>
