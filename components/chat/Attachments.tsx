...
// Full-pane drop affordance, rendered over the whole ChatView/FilesView while a file is dragged
// in. pointer-events-none so the drag/drop events fall through to the container's handlers.
