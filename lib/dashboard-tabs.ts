export const DASHBOARD_TAB_IDS = ["welcome", "start-here", "refer", "chat", "files", "integrations", "shortcuts", "now-what", "checklist", "agent", "agents", "billing", "credits", "settings"] as const;
