-- Dashboard schema (workspaces / memberships / invitations / agents) + RLS.
-- Ported verbatim from agent37-whitelabel supabase/migrations/0001_init.sql.
-- Applied to the dedicated `apolloclaw-dashboard` Supabase project ONLY.
